...
public class PrintCommand {
    ...
    public static byte[] rollback30 = new byte[]{0x1B, 0x6A, 0x30};
    ...
    public static byte[] blank50 = new byte[]{0x1B, 0x4A, (byte) 0x80};
    ...
    public static byte[] position80 = new byte[]{0x1B, 0x24, (byte) 0x80, 0x00};
    public static byte[] reset = new byte[]{0x1B, 0x40};
    public static byte[] line = new byte[]{0x0A};
}
